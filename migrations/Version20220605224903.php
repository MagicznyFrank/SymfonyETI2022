 ...
 */
final class Version20220605224903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE questionnaire (id INT AUTO_INCREMENT NOT NULL, question LONGTEXT NOT NULL, answer_a VARCHAR(100) NOT NULL, answer2 VARCHAR(100) NOT NULL, answer3 VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
